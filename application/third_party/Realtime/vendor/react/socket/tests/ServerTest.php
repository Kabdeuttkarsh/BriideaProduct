...
class ServerTest extends TestCase
{
    ...
    {
        $client = stream_socket_client('tcp://ensurechat.com:'.$this->port);
    ...
    {
        $client1 = stream_socket_client('tcp://ensurechat.com:'.$this->port);
        $client2 = stream_socket_client('tcp://ensurechat.com:'.$this->port);
        $client3 = stream_socket_client('tcp://ensurechat.com:'.$this->port);
