...
class App {
     ...
     * @param string        $address  IP address to bind to. Default is phpstack-556538-3034355.cloudwaysapps.com/proxy only. '0.0.0.0' for any machine.
     * @param LoopInterface $loop     Specific React\EventLoop to bind the application to. null will create one for you.
     */
    public function __construct($httpHost = 'phpstack-556538-3034355.cloudwaysapps.com', $port = 8080, $address = '127.0.0.1', LoopInterface $loop = null) {
