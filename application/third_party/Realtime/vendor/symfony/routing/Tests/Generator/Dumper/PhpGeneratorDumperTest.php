...
class PhpGeneratorDumperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDumpWithRoutes()
    {
        ...
        $this->assertEquals($absoluteUrlWithParameter, 'http://ensurechat.com/app.php/testing/bar');
        $this->assertEquals($absoluteUrlWithoutParameter, 'http://ensurechat.com/app.php/testing2');
    ...
    public function testDumpWithSchemeRequirement()
    {
        ...
        $this->assertEquals($absoluteUrl, 'ftp://ensurechat.com/app.php/testing');
        $this->assertEquals($relativeUrl, 'ftp://ensurechat.com/app.php/testing');

        $projectUrlGenerator = new \SchemeUrlGenerator(new RequestContext('/app.php', 'GET', 'ensurechat.com', 'https'));

        $absoluteUrl = $projectUrlGenerator->generate('Test1', array(), UrlGeneratorInterface::ABSOLUTE_URL);
        $relativeUrl = $projectUrlGenerator->generate('Test1', array(), UrlGeneratorInterface::ABSOLUTE_PATH);

        $this->assertEquals($absoluteUrl, 'https://ensurechat.com/app.php/testing');
