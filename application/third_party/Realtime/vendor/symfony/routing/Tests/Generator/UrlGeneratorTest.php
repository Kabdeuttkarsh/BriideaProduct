...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    public function testAbsoluteUrlWithPort80()
    {
        ...
        $this->assertEquals('http://ensurechat.com/app.php/testing', $url);
    }
    ...
    public function testAbsoluteSecureUrlWithPort443()
    {
        ...
        $this->assertEquals('https://ensurechat.com/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('http://ensurechat.com:8080/app.php/testing', $url);
    }
    ...
    public function testAbsoluteSecureUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('https://ensurechat.com:8080/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('http://ensurechat.com/app.php/testing?foo=bar', $url);
    }
    ...
    {
        $routes = $this->getRoutes('test', new Route('/', array(), array(), array(), '', array('https')));
        $this->assertEquals('https://ensurechat.com/app.php/', $this->getGenerator($routes)->generate('test'));

        $routes = $this->getRoutes('test', new Route('/', array(), array(), array(), '', array('http')));
        $this->assertEquals('http://ensurechat.com/app.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    }
    ...
    public function testSchemeRequirementCreatesUrlForFirstRequiredScheme()
    {
        ...
        $this->assertEquals('ftp://ensurechat.com/app.php/', $this->getGenerator($routes)->generate('test'));
    }
