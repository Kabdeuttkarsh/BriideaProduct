              ...
              if(is_numeric($email)){
                 ...
                 if($users_row=$this->Crud_model->getRows($this->table,$con,'row')){
                     ...
                     if(password_verify($password,$users_row->password)){
                       ...
                       $option = array(
                          'select' => 'user_group.*, designations.*,company.company_name,company.id',
                          'table' =>'user_group',
                          'join' => array(array('designations' => 'designations.id = user_group.group_id','company' => 'company.id ='.$users_row->company_id)),
                     ...
                     $user_group=$this->Crud_model->commonGet($option);
                      ...
                      $logged_in_sess = array(
                            ...
                            'company_name' => $user_group->company_name,
